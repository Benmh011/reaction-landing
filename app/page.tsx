            ...
            {[
              {
                ...
                p: "Fast, hand-built sites for working businesses. We build the shopfront, the booking flow, and the pages a customer actually reads. Every site is designed with intent, hosted and maintained by us, and judged on one thing above all. Does the work come in.",
                flagship: false,
              },
              {
                num: "02",
                ...
                p: "Client portals, internal tools, and practice dashboards. These are the systems that run behind the counter. We build them on modern foundations and shape them around the way your team already works, so the software bends to fit the business rather than forcing the business to fit the software.",
                flagship: false,
              },
              {
                num: "03",
                ...
                p: "Our flagship. Formations of small, specialised agents run on infrastructure you control, applying themselves to your heaviest work while your people hold the dial. A website brings the work in. Software organises it. A locally hosted multi-agentic system is what moves it.",
                flagship: true,
              },
            ].map((b) => (
